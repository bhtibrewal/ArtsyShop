    ...
    <main className="main center">
      ...
      >
        ...
        <InputField
          value={firstName}
          onChange={(e) =>
            setInputValues({ ...inputValues, firstName: (e.target as HTMLInputElement).value, })
          }
          label={"First Name"}
        />
        <InputField
          value={lastName}
          onChange={(e) =>
            setInputValues({ ...inputValues, lastName: (e.target as HTMLInputElement).value, })
          }
          label={"Last Name"}
        />
        <InputField
          value={email}
          onChange={(e) =>
            setInputValues({ ...inputValues, email: (e.target as HTMLInputElement).value, })
          }
          label={"Email"}
        />
        {!validEmail && email !== "" && (
